      ...
      <div id="Principal">
        ...
        <form id="regForm" action="/action_page.php">
          ...
          <div className="tab">
            Birthday:
            <p>
              <input placeholder="dd" name="dd" />
            </p>
            <p>
              <input placeholder="mm" name="nn" />
            </p>
            <p>
              <input placeholder="yyyy" name="yyyy" />
            </p>
          </div>
          ...
          <div className="actions">
            <div >
              <button type="button" id="prevBtn" onclick={this.nextPrev(-1)}>Previous</button>

              <button type="button" id="nextBtn" onclick={this.nextPrev(1)}>Next</button>
            </div>
          </div>
